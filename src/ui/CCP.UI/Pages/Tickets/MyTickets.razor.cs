...
public partial class MyTickets : ComponentBase
{
    ...
    private async Task LoadTicketsAsync()
    {
        ...
        {
            Logger.LogError("MyTickets failed to load tickets for customer {UserId}: {Error}",
